from tool import estimate_travel_time,recommend_entertainment_places,recommend_food_places, get_weather,get_uber_link
...
email_agent = Agent(
    model=MODEL,
    name="MobilityAgent",
    tools=[estimate_travel_time, recommend_entertainment_places, recommend_food_places, get_weather, get_uber_link],
    instruction=
    '''
